...
class ComposerStaticInitdc91119e814e712461766207c2826c8b
{
    ...
    public static $classMap = array (
        ...
        'Deposit' => __DIR__ . '/../..' . '/model/Desposit.class.php',
        'EasyPeasyICS' => __DIR__ . '/..' . '/phpmailer/phpmailer/extras/EasyPeasyICS.php',
        'EnviarEmail' => __DIR__ . '/../..' . '/model/EnviarEmail.class.php',
        'Historic' => __DIR__ . '/../..' . '/model/Historic.class.php',
        ...
        'Transfer' => __DIR__ . '/../..' . '/model/Transfer.class.php',
        'User' => __DIR__ . '/../..' . '/model/User.class.php',
        'UserBasic' => __DIR__ . '/../..' . '/model/UserBaisc.class.php',
        'UserInterface' => __DIR__ . '/../..' . '/model/UserInterface.php',
        'UserPremium' => __DIR__ . '/../..' . '/model/UserPremium.class.php',
        'UserSalary' => __DIR__ . '/../..' . '/model/UserSalary.class.php',
        'Withdraw' => __DIR__ . '/../..' . '/model/Withdraw.class.php',
